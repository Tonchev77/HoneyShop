...
namespace HoneyShop.Data.Migrations
{
    ...
    [Migration("20250730212527_InitialSeedForStatusesAndWarehouses")]
    partial class InitialSeedForStatusesAndWarehouses
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HoneyShop.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "0dd0d4e8-69a2-4a65-a04c-cab80edf77c2",
                            Email = "admin@honeyshop.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@HONEYSHOP.COM",
                            NormalizedUserName = "ADMIN@HONEYSHOP.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAEIHpRDO+tPNlRCs80OV46T8wdKq+HvVHBMBxwh8k2BC+5pZNPTKb3RESR0rqe89qKA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "e0720c8b-d544-484b-a754-9f2c0f83e0df",
            ...
            modelBuilder.Entity("HoneyShop.Data.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 7, 30, 21, 25, 27, 29, DateTimeKind.Utc).AddTicks(8866),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 7, 30, 21, 25, 27, 29, DateTimeKind.Utc).AddTicks(8872),
                            CreatorId = "15167365-502c-42be-9f14-3e623c2e465e",
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 7, 30, 21, 25, 27, 29, DateTimeKind.Utc).AddTicks(8876),
                            CreatorId = "15167365-502c-42be-9f14-3e623c2e465e",
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 7, 30, 21, 25, 27, 29, DateTimeKind.Utc).AddTicks(8881),
                            CreatorId = "15167365-502c-42be-9f14-3e623c2e465e",
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 7, 30, 21, 25, 27, 29, DateTimeKind.Utc).AddTicks(8884),
                            CreatorId = "15167365-502c-42be-9f14-3e623c2e465e",
            ...
            modelBuilder.Entity("HoneyShop.Data.Models.Cart", b =>
                {
                    b.HasOne("HoneyShop.Data.Models.ApplicationUser", null)
                        .WithMany("Carts")
                        .HasForeignKey("ApplicationUserId");

                    b.HasOne("HoneyShop.Data.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("HoneyShop.Data.Models.Manager", b =>
                {
                    b.HasOne("HoneyShop.Data.Models.ApplicationUser", "User")
                        .WithOne("Manager")
                        .HasForeignKey("HoneyShop.Data.Models.Manager", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("HoneyShop.Data.Models.Product", b =>
                {
                    ...
                    b.HasOne("HoneyShop.Data.Models.ApplicationUser", "Creator")
                        .WithMany()
